object Form1: TForm1
  ...
  object pnlSightBlock: TPanel
    ...
    TabOrder = 5
    Visible = False
    OnAlignPosition = pnlSightBlockAlignPosition
    object lblCustomize: TLabel
    ...
    object pnlParentContainer: TPanel
      Left = 57
      Top = -2
      Width = 375
      Height = 344
      Align = alCustom
      TabOrder = 0
      object lblCustomHeight: TLabel
        Left = 114
        Top = 79
        Width = 76
        Height = 15
        Caption = 'CustomHeight'
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'Impact'
      ...
      object lblCustomSqrSize: TLabel
        Left = 114
        Top = 222
        Width = 82
        Height = 15
        Caption = 'CustomSqrSize'
        Font.Charset = ANSI_CHARSET
        Font.Color = clWindowText
        Font.Height = -11
        Font.Name = 'Impact'
      ...
      object scrlbrHeight: TScrollBar
        Left = 114
        Top = 250
        Width = 127
        Height = 32
      ...
      object scrlbrSQRS: TScrollBar
        ...
        PageSize = 0
        TabOrder = 1
        OnChange = scrlbrSQRSChange
      end
      object scrlbrWidth: TScrollBar
        Left = 114
        Top = 185
        Width = 127
        Height = 31
  ...
  object tmrButton: TTimer
    Interval = 500
    OnTimer = tmrButtonTimer
    Left = 176
    Top = 312
  end
end
